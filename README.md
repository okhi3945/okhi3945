### 💡 소개
저는 선문대학교 컴퓨터공학부와 SW중심대학 몰입형 교육 과정을 통해 Java와 Spring Boot MVC 등을 학습하여 여러 팀 프로젝트를 진행하였습니다. 그리고 CJ OliveNetworks Cloud Wave 4기를 수료하며 AWS, CI/CD, Terraform, Docker 등을 사용하여 실제 CGV 인프라를 구축하고, 비용 최적화를 목표로 하는 프로젝트를 진행하였습니다. 또한, MySQL, MongoDB, DynamoDB 등을 이용한 데이터베이스 설계 및 구축 경험이 있습니다.

저는 신입으로서 열정적으로 일하고, 지속적인 성장을 추구합니다. 회사에 입사하여 빠르게 적응하고, 회사와 함께 성장하고 싶습니다. 동료들과의 원활한 소통을 통해 팀 프로젝트를 성공적으로 이끌어 나가는 것을 최우선으로 생각합니다. 함께 일하는 동료들과의 협업을 통해 서로의 역량을 끌어올리며, 소통을 잘하면 그만큼 더 좋은 결과물을 이끌어낼 수 있다고 생각합니다
